...
These preprocessing steps are PGD attack and CROWN. PGD attack is to generate the counter example
and if it fails then CROWN runs to generate the bounds.  
