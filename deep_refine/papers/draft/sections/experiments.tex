...
The tools \alphabeta{} and \ovaltool{} use a set/portfolio of different algorithms and optimizations. \alphabeta{} achieved the first rank consistantly in both International Verification of Neural Networks Competition(VNN-COMP'21) and VNN-COMP'22. %The tool \marabou{} achieved the 6th ranks in VNN-COMP'22.  
...
in VNN-COMP'21. We use the same configuration to run \alphabeta{} and \ovaltool{}, which these tools used in VNN-COMP.
