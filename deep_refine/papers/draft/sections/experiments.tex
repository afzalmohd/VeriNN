...
\paragraph{Comparison with aversarially trained networks: }
{\color{red} I will add the seperate comparison with \alphabeta{} on adversarially generated network. I will also add a paragraph to 
explain the newly generated benchmarks and results on them.}

\paragraph{Subroutine time: }

{\color{red} I will add the time breakdown for getmarkneuron and refinement procedure 
once complete the experiment with split time logs.}
