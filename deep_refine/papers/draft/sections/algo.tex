...
The first line of the algorithm performs preprocessing steps similar to \alphabeta{} tools, which include 
PGD attack, followed by Crown which is an incomplete tool followed by MIP to tighten the bounds.\todo{these are not defined anywhere. what is PGD attack? why does preproc return a cex?}
More explanations are in Experiment section~\ref{sec:experiments}. ~\todo{explanations missing}
...
\todo{do you use the cex returned by preproc in line 8?}
