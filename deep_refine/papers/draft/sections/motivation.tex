...
%\\
\noindent\textbf{Optimization based approach to identify marked neurons}\\
...
Then we feed this to a maxsat solver \todo{check! afzal} to maximize the soft constraints, while maintaining the hard constraints.
