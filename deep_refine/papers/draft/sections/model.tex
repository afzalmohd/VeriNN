...
The network is defined in definition \ref{def:net}. 
...
as {\em hidden layers}. We assume a separate layer for the activation function. Though there are different kinds of
activation, we focus only on \relu{}, hence each layer can either be an affine layer or a \relu{} layer.
