...
Without loss generality, we assume that the output layer is an affine(identity) layer, 
since we can always append an affine layer in neural network. 
and each hidden layer is followed by an activation function. 
