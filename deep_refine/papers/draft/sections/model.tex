...
In case of \texttt{UNSAT}, it return the \texttt{UnsatCore}. 
The \texttt{UnsatCore} is a subset of constrains, which are still \texttt{UNSAT}, 
but if a single constraint removed from \texttt{UnsatCore} then it become \texttt{SAT}.
