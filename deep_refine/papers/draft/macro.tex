...
\newcommand{\affine}{\mathtt{Affine}}
\newcommand{\relu}{\mathtt{ReLU}}
\newcommand{\deeppoly}{\texttt{DeepPoly}}
\newcommand{\kpoly}{\texttt{kPoly}}
\newcommand{\deepsrgr}{\texttt{deepSRGR}}
\newcommand{\alphabeta}{$\alpha - \beta$-CROWN}
\newcommand{\ovaltool}{\texttt{Oval}}
\newcommand{\drefine}{\texttt{our refine}}
\newcommand{\markednewrons}{\emph{markedNeurons}}
\newcommand{\milp}{\texttt{MILP}}
\newcommand{\sat}{\texttt{SAT}}
\newcommand{\unsat}{\texttt{UNSAT}}
\newcommand{\unsatcore}{\texttt{UnsatCore}}
