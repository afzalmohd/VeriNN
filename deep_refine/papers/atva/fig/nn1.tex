\begin{tikzpicture}[
    ...
    net/.style={
        matrix of nodes,
        nodes={ draw, circle, inner sep=1.5pt },
...
% Define layer headings
   ...
   & |[clear]|  \parbox{2cm}{\centering $\langle x_7 \geq x_5$, \\ $x_7 \leq x_5$, \\ $l_1 = 0$, \\ $u_1 = 2 \rangle$} \\
...
& |[clear]| \parbox{2cm}{\centering $\langle x_8 \geq x_6+1$, \\ $x_8 \leq x_6+1$, \\ $l_1 = 0$, \\ $u_1 = 2 \rangle$} \\
};
...
\draw[->] (mat-2-1) -- (mat-6-2) node[pos=0.35, above] {$1$};
\draw[->] (mat-6-1) -- (mat-2-2) node[pos=0.15, above] {$1$};
\draw[->] (mat-6-1) -- (mat-6-2) node[pos=0.5, below] {$1$};
...
\draw[->] (mat-6-3) -- (mat-6-4) node[pos=0.5, below] {$1$};
