...
\scalebox{0.7}{
  ...
  \caption{(a) Neural networks details (b) Cactus plot~\cite{brain2017benchmarking} with related techniques: 
    The x-axis represents the number of benchmarks solved, sorted in increasing order based on the time taken to solve them. 
